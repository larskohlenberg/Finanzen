...
| 16 | Was darf der Import-Agent? | Quellen, Importlaeufe, Rohumsaetze, initiale Modellumsaetze, Vorschlaege/Warnungen und Laufprotokoll schreiben. | Er uebernimmt Daten, entscheidet aber keine neuen Regeln final. |
| 17 | Was darf der Analyse-Agent? | Vorschlaege, Warnungen und Laufprotokoll erzeugen. | Mustererkennung bleibt entscheidungspflichtig. |
...
| 36 | Welche Agentenartefakte gehoeren in Excel? | Nur entscheidungsrelevante Vorschlaege, Warnungen, Quellen- oder Laufhinweise. | Excel soll offenlegen, was der Nutzer entscheiden muss, nicht Test- und Agenteninnenleben dauerhaft bedienen. |
| 37 | Welche Agentenartefakte bleiben ausserhalb von Excel? | Fixtures, Inspector-Snapshots, Subagenten-Rohantworten, Compliance-Testdaten und Testmappen bleiben in `workbook-build/`. | Diese Artefakte sichern Qualitaet, sind aber keine Finanzentscheidungssicht. |
| 38 | Wird V1 weiter verengt? | Ja: Der Startbuild priorisiert Dashboard, Import, Modellumsaetze, Cashflow, Liquiditaet, Annahmen, Quellen, Warnungen und Vorschlaege. | Ein kleiner beweisbarer Kern ist besser als eine breite halbfertige Mappe. |
...
- `workbookSpec.mjs` fuer den V1-Mindestkern implementieren.

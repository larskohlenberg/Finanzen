...
- Agentenworkflow bleibt wichtig, aber in Excel werden nur entscheidungsrelevante Vorschlaege, Warnungen, Quellen, Laufanker und Compliance-Status sichtbar.
...
6. `workbookSpec.mjs` fuer die `muss`-Tabellen des V1-Mindestkerns implementieren, inklusive `98_Kontrollspur`.

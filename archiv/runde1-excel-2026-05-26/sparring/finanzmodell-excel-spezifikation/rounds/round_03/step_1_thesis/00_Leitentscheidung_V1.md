...
8. Ein minimales Kontrollblatt `98_Kontrollspur` fuer Build-Verifikation, Agentenlaeufe und externe Artefakt-Referenzen.
...
- dependency-orientierte Tabellen-Startreihenfolge,
...
- die drei minimalen Kontrollspur-Tabellen auf genau einem Blatt `98_Kontrollspur`.

Die Markdown-Dateien bleiben die fachliche Quelle. Wenn eine Regel nicht entschieden ist, darf der Builder keinen stillen Default erfinden. Er baut dann eine offene Stelle mit Status, Check, Warnung oder Vorschlag.

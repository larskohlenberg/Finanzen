...
Der erste technische Meilenstein ist kein vollstaendiges Ausprogrammieren aller V1-Formeln. Er ist ein vertikaler Nachweis:

- ein minimaler Stammdatensatz,
- ein kleiner Girokonto-Import,
- daraus getrennte Importlauf-, Rohumsatz- und Modellumsatzzeilen,
- eine Liquiditaets- und Cashflow-Kennzahl,
- mindestens ein Check,
- ein Dashboardstatus Rot oder Gelb,
- ein Kontrollstatus, der eine fehlende oder bestandene Verifikation sichtbar macht.

Dieses Gate entscheidet, ob die Struktur tatsaechlich den Familien-Nutzwert traegt. Erst danach wird die Breite der Muss-Tabellen vollstaendig ausgebaut. Eine rote oder gelbe Mappe ist in diesem Gate ausdruecklich richtig, wenn sie Unsicherheit ehrlich zeigt.

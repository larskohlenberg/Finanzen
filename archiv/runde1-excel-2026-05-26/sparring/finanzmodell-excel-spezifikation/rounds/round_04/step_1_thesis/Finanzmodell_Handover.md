...
2. `Finanzmodell_Entscheidungsprotokoll.md`  
   Enthaelt die aktiven Entscheidungen und Begruendungen, einschliesslich Task-1-Schnitt, konkretisiertem Thin-Slice-Gate und Wegfall der separaten Startreihenfolge-Datei.
...
- Der Thin-Slice-Test ist jetzt konkret: Er prueft eine Startkette aus Person/Haushalt, Kategorie `KAT013`, Girokonto, aktivem Szenario, Annahme, Quelle, Importlauf, Rohumsatz, Modellumsatz, Check und Dashboardstatus.
...
7. Im Test explizit pruefen, dass der Slice strukturell bleibt: `task1Scope = "structure_and_seed_contract"` und `formulaImplementationTask = 3`.
...
- keine Task-3-Formeln werden in Task 1 versteckt.

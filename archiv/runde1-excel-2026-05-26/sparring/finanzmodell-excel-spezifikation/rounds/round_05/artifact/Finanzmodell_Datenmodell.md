...
Task 1 beweist den V1-Kern nicht durch vollstaendige Formeln und nicht durch eine fertige Entscheidungssicht. Er beweist, dass die spaetere Entscheidungssicht strukturell tragfaehig, referenzierbar und nicht unsichtbar-gruen ist. Der Durchstich ist akzeptiert, wenn `workbookSpec` und `seedData` gemeinsam diese Mindestkette beschreiben:

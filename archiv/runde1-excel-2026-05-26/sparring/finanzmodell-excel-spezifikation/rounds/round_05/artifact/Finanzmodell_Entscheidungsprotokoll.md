...
| 49 | Baut Task 1 alle Muss-Tabellen oder zuerst einen Nutzwert-Slice? | Task 1 beginnt mit einem Struktur- und Beobachtbarkeits-Gate und endet mit dem strukturellen Vertrag fuer alle Muss-Tabellen. | Der Slice verhindert blinde Tabellenabschrift; der Vertrag verhindert, dass spaetere Tasks auf unfertiger Struktur bauen. Der echte Nutzwert aus berechneter Liquiditaet, Cashflow und Reichweite beginnt erst mit Task 3. |
...
4. Thin-Slice-Test fuer Rot/Gelb-Dashboardstatus mit konkret benannten Minimal-Seeds, Check-Rueckbindung und Quellen-/Kontrollspurbezug formulieren.

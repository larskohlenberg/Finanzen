...
- TDD beginnt mit einem Struktur- und Beobachtbarkeits-Slice und erweitert danach die Breite des V1-Vertrags.
...
## Task 1: `workbookSpec` mit erstem Struktur- und Beobachtbarkeits-Gate
...
Task 1 darf den roten oder gelben Status als Start-Dashboardzustand aus `seedData` sichtbar machen. Er darf pruefen, dass die dafuer benoetigten Tabellen und Seed-Zeilen existieren, zusammen referenzierbar sind und der sichtbare Status aus mindestens einem vorhandenen Check mit Quellen-, Annahmen-, Import- oder Kontrollspurbezug erklaerbar ist.

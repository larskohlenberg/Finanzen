...
const report = await runLimitedAgentDraftImport({
  ...
  outputPath: "./outputs/finanzmodell-v1-startmappe/Finanzmodell_V1_AgentDraft_Full.xlsx",
  maxTransactions: 100000,
  ids: {
    sourceId: "SRC-20260516-FULLDRAFT",
    importId: "IMP-20260516-FULLDRAFT",
    runId: "RUN-20260521-FULLDRAFT",
    warningId: "WRN-IMPORT-DRAFT-FULL",
    checkId: "CHK-IMPORT-DRAFT-FULL",
  },
  accountId: "KTO001",
  personId: "P01",
